...
<style>
    ...
    .stat-card {
        ...
        border-radius: 16px;
        padding: 24px;
        box-shadow: 0 2px 8px rgba(74, 150, 104, 0.08);
    ...
    .stat-card::before {
        ...
        width: 4px;
        height: 100%;
        background: linear-gradient(180deg, #4a9668, #2d5f3f);
        opacity: 0;
    ...
    .stat-card:hover {
        ...
        box-shadow: 0 8px 20px rgba(74, 150, 104, 0.15);
    }
            ...
            datasets: [
                {
                    ...
                    data: data.earliest,
                    borderColor: "#2d5f3f",
                    backgroundColor: "rgba(74, 150, 104, 0.1)",
                    borderWidth: 3,
                    tension: 0.4,
                    pointRadius: 5,
                    pointHoverRadius: 7,
